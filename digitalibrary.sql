...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Oct 09, 2024 at 01:38 AM
...
(1, 'Negeri Para Bedebah', 'Tere Liye', 'Gramedia', 2012, 'kosong', 'novel', 'negerii.jpg', 'negeri.pdf'),
(3, 'Laskar Pelangi', 'Andrea Hirata', 'Bentang Pustaka', 2005, 'kosong', 'novel', 'laskar.jpg', 'laskar.pdf'),
(4, 'Gadis Kretek', 'Ratih Kumala', 'Gramedia', 2012, 'kosong', 'novel', 'gadis.jpg', 'gadis.pdf'),
(5, 'Daun yang Jatuh Tak Pernah Membenci Angin', 'Tere Liye', 'Gramedia', 2010, 'tersedia', 'novel', 'daunjatuhh.jpg', 'daunjatuh.pdf'),
(6, 'Death Note Black Edition', 'Tsugumi Ohba', 'Gramedia', 2010, 'tersedia', 'komik', 'death.jpg', 'death.pdf'),
(7, 'Bobo Edisi 48 2022', 'Bobo', 'Sarana Bobo', 2022, 'tersedia', 'majalah', 'bobo.jpg', 'bobo.pdf'),
(8, 'Laut bercerita', 'Leila S Chudori', 'Gramedia', 2017, 'tersedia', 'novel', 'laut.jpg', 'laut.pdf'),
(9, 'Lelaki Harimau', 'Eka Kurniawan', 'Gramedia', 2004, 'tersedia', 'novel', 'lelakii.jpg', 'lelaki.pdf'),
(10, 'Ronggeng Dukuh Paruk', 'Ahmad Tohari', 'Gramedia', 1982, 'tersedia', 'novel', 'ronggeng.png', 'ronggeng.pdf'),
(12, 'Entrok', ' Okky Madasari', 'Gramedia', 2010, 'tersedia', 'novel', 'entrox.jpg', 'entrokk.pdf'),
(11, 'Kita Pergi Hari Ini', ' Ziggy Zezsyazeoviennazabrizkie', 'Gramedia', 2021, 'tersedia', 'novel', 'kitapergi.jpg', 'kitapergi.pdf'),
(2, 'Bumi Manusia', 'Pramoedya Ananta Toer', 'Lentera Dipantara', 1980, 'tersedia', 'novel', 'bumi.jpg', 'bumi_manusia.pdf'),
(12345, 'percobaan', 'aspasya salsabila', 'ohmediapanelstudio', 2007, 'tersedia', 'majalah', 'kitapergi.jpg', 'cobaan.pdf');
...
(8, 8, 5, 'bagus banget guys kalian harus baca!!!!', 4);
